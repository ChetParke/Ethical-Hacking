...
- We increment the get request all the way down trying 5.txt, 4.txt ... and finally we attemp 1.txt. And it works...
...
#### 6 - Root Cause
The application is relying on user supplied file names within GET request and is not verifying that the authenticaed user is authorized to access the specific file. This allows attackers to modify the parameters of the request and access files that do not belong to them.
